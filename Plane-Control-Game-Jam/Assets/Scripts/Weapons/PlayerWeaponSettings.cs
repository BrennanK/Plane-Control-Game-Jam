...
public class PlayerWeaponSettings : ScriptableObject
{
    ...
    [field: SerializeField] public float MaxRandomAdditionToFireInterval { get; private set; } = 0;
    [field: SerializeField] public float EnemyDetectionRadius { get; private set; } = 5;
    [field: SerializeField] public float EnemyDetectionMaxDegreesFromLookDirection { get; private set; } = 0;
